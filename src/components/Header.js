...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-[#020617] border-b border-emerald-500/30 shadow-[0_4px_30px_rgba(0,0,0,0.5)]">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center px-4 py-4 gap-4">
        ...
        <div className="flex w-full md:w-auto items-center justify-center md:justify-end">
          <ul className="flex flex-wrap items-center justify-center gap-4 md:gap-8 font-bold text-gray-300">
            {/* Status logic integrated here */}
            <li className="px-4 py-2 bg-white/5 rounded-full border border-white/10 text-sm">
              Online Status:{" "}
              {onlineStatus && isUserLoggedIn ? "✅ Online" : "⛔ Offline"}
            </li>
